...
### Start kc server
1. Download and unback Keycloak ([Documentation](https://www.keycloak.org/getting-started/getting-started-zip))
...
5. Run ```start-dev --https-certificate-file=certs/cert.pem --https-certificate-key-file=certs/unencrypted_key.pem --http-enabled=true --hostname=kc.idp.com```
